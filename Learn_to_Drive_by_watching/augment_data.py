...
for data in train_data:
    ...
    if choice == [1,0,0,0]:
        ...
        lefts.append([img-10,choice])
        rights.append([cv2.flip(img,1), [0,0,1,0]])
        rights.append([cv2.flip(img,1)-10, [0,0,1,0]])
    elif choice == [0,1,0,0]:
        accelerate.append([img,choice])
    elif choice == [0,0,1,0]:
        rights.append([img,choice])
        rights.append([img-10,choice])
        lefts.append([cv2.flip(img,1), [1,0,0,0]])
        lefts.append([cv2.flip(img,1)-10, [1,0,0,0]])
    elif choice == [0,0,0,1]:
...
np.save('training_data_augmented.npy', balanced_data)
