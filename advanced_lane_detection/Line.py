...
# Taken from https://github.com/pkern90/CarND-advancedLaneLines/blob/master/LaneDetection/Line.py
...
class Laneline:
    def __init__(self, n_frames=1, x=None, y=None):
        ...
        :param x: initial x coordinates = all_x[i] fetched from histogram_lane_detection function
        :param y: initial y coordinates = all_y[i] fetched from histogram_lane_detection function
        """
        # Frame memory
        ...
        self.ally = None
        # Type of lane left_detected
        self.lanetype = lanetype(0)
        # Position of LaneLine
        self.lanepos = None
    ...
    def get_current_fit_distance(self, other_line):
        ...
        :return:
        """
        return np.abs(self.current_fit_poly(479) - other_line.current_fit_poly(479))
    ...
    def get_best_fit_distance(self, other_line):
        ...
        :return:
        """
        return np.abs(self.best_fit_poly(479) - other_line.best_fit_poly(479))
...
def calc_curvature(fit_cr):
    ...
    xm_per_pix = 2 / 640  # meteres per pixel in x dimension

    y = np.array(np.linspace(0, 479, num=10))
